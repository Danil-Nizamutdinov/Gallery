...
import {getPaintings, getPaintingsSearch, setPaintings,} from "../../redux/Gallery-Reducer";
...
class GalleryAPIContainer extends React.Component {
    componentDidUpdate() {
      ...
      this.props.setLocationAuthorToggle(this.props.locationToggler, this.props.authorToggler, bodyTextToggler)

      const locationId = this.props.locationToggler ? this.props.locationId : null
      ...
      this.props.locationAuthorToggle ? this.props.getPaintingsSearch(authorId,locationId,bodyText) : this.props.getPaintings(this.props.currentPage)
    }

    render() {
      
      return <Gallery paintings={this.props.paintings} authors={this.props.authors} locations={this.props.locations} maxSymbols={this.props.maxSymbols}/>
...
const GalleryContainer = connect(mapStateToProps, {getPaintings, getPaintingsSearch, setPaintings, setLocationAuthorToggle})(GalleryAPIContainer)
