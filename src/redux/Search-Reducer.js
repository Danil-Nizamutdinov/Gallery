...
const searchReducer = (state = initialState, action) => {
    switch(action.type) {
        ...
        case 'LOCATION_AUTHOR_TOGGLE':
            return{
                ...state,
                locationAuthorToggle:action.newLocationToggle + action.newAuthorToggle + action.newbodyTextToggler
            }
...
export const updateNameText = (text) => ({type: 'UPDATE-NEW-NAME-TEXT', newBodyText: text})

export const newMaxSymbols = (maxSymbols) => ({type: 'MAX-SYMBOLS', maxSymbols})

export const updateCreatedFromText = (text) => ({type: 'UPDATE-NEW-CREATED-FROM-TEXT', newBodyTextCreatedFrom: text})
export const updateCreatedBeforeText = (text) => ({type: 'UPDATE-NEW-CREATED-BEFORE-TEXT', newBodyTextCreatedBefore: text})

export const setLocation = (text, LocationId) => ({type: 'SET_LOCATION', newLocation: text,  newLocationId:LocationId})
export const setLocationToggleFalse = () => ({type: 'LOCATION_TOGGLE_FALSE'})

export const setAuthor = (text, AuthorId) => ({type: 'SET_AUTHOR', newAuthor: text, newAuthorId:AuthorId})
export const setAuthorToggleFalse = () => ({type: 'AUTHOR_TOGGLE_FALSE'})

export const setStyleToggle = () => ({type: 'STYLE-TOGGLE'})

export const setLocationAuthorToggle = (locationToggle, authorToggle,bodyTextToggler) => ({
